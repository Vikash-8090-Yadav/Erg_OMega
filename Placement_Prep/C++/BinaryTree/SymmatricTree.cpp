...
/*
 * Problen name : Symatruc binary tree
 * */
...
bool flag = false;
int SymBinary(TreeNode* root,TreeNode* root1){
	if(root==NULL || root1==NULL){
		return (root==root1);
	}

	return (root->data==root1->data)&&SymBinary(root->left,root1->right)&& SymBinary(root->right,root1->left);
}
...
int main(){
	...
	cout<<SymBinary(n1->left,n1->right);
